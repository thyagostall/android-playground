...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        result.addURI(authority, WeatherContract.PATH_WEATHER, WEATHER);
        result.addURI(authority, WeatherContract.PATH_WEATHER + "/*", WEATHER_WITH_LOCATION);
        result.addURI(authority, WeatherContract.PATH_WEATHER + "/*/#", WEATHER_WITH_LOCATION_AND_DATE);

        result.addURI(authority, WeatherContract.PATH_LOCATION, LOCATION);
